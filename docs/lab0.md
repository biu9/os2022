...
=======
请根据 [https://docs.docker.com/get-docker](https://docs.docker.com/get-docker) 自行在本机安装 Docker 环境。你可以从 [2 实验环境](#2 实验环境) 中获得实验所需的环境，我们已经为你准备好了 RISC-V 工具链，以及 QEMU 模拟器，使用方法请参见 [4 实验步骤](#4 实验步骤)。
>>>>>>> 81665e4be2cbf50c23c647e87010ea655e4f24fc
...
# 从终端连入 docker 容器
$ docker exec -it oslab-test bash
...
=======
> Tips: 对于 5.15 及以上版本的 Linux 源码，编译后、使用 gdb 调试时，需先执行 `set riscv use-compressed-breakpoints on` 命令，才能打断点、正常调试。
>>>>>>> 81665e4be2cbf50c23c647e87010ea655e4f24fc
